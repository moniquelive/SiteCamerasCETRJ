  ...
  $.fn.tweet = function(o){
    ...
    $.fn.extend({
      ...
      linkUser: function() {
        ...
        this.each(function() {
          returning.push(this.replace(regexp,"<a target=\"_blank\" href=\"http://"+s.twitter_url+"/$1\">@$1</a>"));        });
        return $(returning);
      },
      linkHash: function() {
        var returning = [];
        ...
        this.each(function() {
          returning.push(this.replace(regexp, ' <a target=\"_blank\" href="http://'+s.twitter_search_url+'/search?q=&tag=$1&lang=all'+usercond+'">#$1</a>'));
        });
        return $(returning);
      },
      capAwesome: function() {
